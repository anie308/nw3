  ...
  return (
    <div>
      <div className="font-notosans  h-[600px] lg:h-screen w-full relative">
        <Image priority src={Bghead} alt="bg-head"  className="absolute h-full w-full top-0 object-cover"/>
      ...
      <div className="bg-[#0B0B0D] w-full flex items-center justify-center">
